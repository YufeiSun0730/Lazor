...
def find_path(currentPos, currentDir, need_to_cross, block_A, block_B, block_C, path, grid):
    ...
    list_of_positions = []
    [list_of_positions.append(x) for x in potential_blockpos if x not in list_of_positions]
    potential_blockpos = list_of_positions.pop()
...
if __name__ == "__main__":
    grid, usable_blocks, start_point, direction, points, block_grid = read_bff("/Users/mordredyuan/Downloads/Lazor-main/LazorProjectFall2021/dark_1.bff")
