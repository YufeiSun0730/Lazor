...
class Lasor():
    ...
    def current_lazor_path(start, direction, grid):
        path = []
        current_pos = start
        current_dir = direction

        while pos_check(current_pos, grid): # need to change to out of range
...
def type_and_number(block_A, block_B, block_C):
    block_A = []
    block_B = []
    block_C = []
